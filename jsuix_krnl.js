...
var conf_defaultmail='QbasicFan';
var conf_defaulturl='';
var os_version='Javascript Unix v 1.2 - \nVist my blog http://retrophylien.net16.net/  \nWant a website for your small business goto www.bznest.xyz\n';
var os_greeting=' '+os_version+' - Virtual OS and terminal application on Javascript . \n---------------------------\n';
...
*/ 
	...
	if ((fn) && (pn)) {
/*
not sure about this test will always return true 
fn refers to the addredd of fn()
but fn() will return a variable value 
